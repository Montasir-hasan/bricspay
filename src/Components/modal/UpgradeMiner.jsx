...
const UpgradeMiner = ({ isVisible, onClose }) => {
  ...
  // ... (storeWalletAddress and useEffect for it remain the same)
  ...
  const transferTon = async (amount) => {
    ...
    try {
      ...
      if (telegramUserId) {
        ...
        // No need to getDoc here, just update
        await updateDoc(userDocRef, {
            ...
            // BUG FIX: The line updating the 'counter' has been REMOVED.
        });
      }
